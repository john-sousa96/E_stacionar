<%@ Page Title="" Language="C#" MasterPageFile="~/tabela.Master" AutoEventWireup="true" CodeBehind="gerenciar-estacionamentos.aspx.cs" Inherits="WebEstacionamento.gerenciar_estacionamentos" %>
<%@ MasterType VirtualPath="~/tabela.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Tabela_title" runat="server">Gerenciar Estacionamentos · Estacionamento</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Tabela_PreGrid" runat="server">
    ...
    <h4><i class="fas fa-parking"></i> Gerenciar Estacionamentos</h4>
    <hr>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="Tabela_PostGrid" runat="server">
    <a id="btnAdicionar" class="btn btn-success" href="./cadastro-estacionamento.aspx" role="button"><i class="fas fa-plus"></i> Adicionar</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Desativar Estacionamento</h5>
                ...
                <asp:UpdatePanel ID="upDeletar" runat="server">
                    <ContentTemplate>
                        <div class="modal-body">
                            ...
                            <p>Deseja realmente desativar o estacionamento selecionado?</p>
                        </div>
                        <div class="modal-footer">
                            ...
                            <asp:Button ID="btnDesativarEstacionamento" CssClass="btn btn-danger" runat="server" Text="Desativar" ToolTip="Desativar Estacionamento" OnClientClick="removerSelecao(this);" OnClick="btnDesativarEstacionamento_Click" />
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                        </div>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="btnDesativarEstacionamento" EventName="Click" />
                    </Triggers>
                </asp:UpdatePanel>
            </div>
        </div>
